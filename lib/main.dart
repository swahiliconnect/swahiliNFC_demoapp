...
class _NFCHomePageState extends State<NFCHomePage>
  ...
  Future<void> _writeLink() async {
    ...
    try {
      ...
      final cardData = BusinessCardData(
        ...
        custom: {'type': 'link', 'url': _linkUrlController.text.trim()},
      );
      ...
      setState(() {
        _statusMessage =
            success ? 'Link written successfully!' : 'Failed to write to card.';
        _isOperationInProgress = false;
      });
  ...
  Future<void> _writeContact() async {
    ...
    try {
      ...
      if (success) {
        _showSuccessDialog(
          'Success',
          'Contact information written successfully to card',
        );
    ...
    showDialog(
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: const Text(
              'In a full implementation, this would share the contact as a VCF file or via other sharing methods.',
            ),
            actions: [
              TextButton(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildOptionCard(
                        ...
                        onTap:
                            () => setState(() => _selectedWriteOption = 'link'),
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed:
                  _isNfcAvailable && !_isOperationInProgress
                      ? _writeContact
                      : null,
              icon: const Icon(Icons.contactless),
              label: const Text(
                'WRITE CONTACT TO NFC CARD',
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed:
                  _isNfcAvailable && !_isOperationInProgress ? _readTag : null,
              icon: const Icon(Icons.contactless),
              label: const Text(
                'READ NFC CARD',
                style: TextStyle(fontSize: 16),
  ...
  Widget _buildScannedCardDisplay(ThemeData theme) {
    ...
    final isLink =
        card.custom.containsKey('type') && card.custom['type'] == 'link';
          ...
          children: [
            ...
            if (isLink) ...[
              ...
              if (card.social.isNotEmpty) ...[
                ...
                ...card.social.entries.map(
                  (entry) => _buildSocialRow(
                    theme,
                    entry.key,
                    entry.value,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('No card scanned yet', style: theme.textTheme.titleMedium),
            const SizedBox(height: 8),
            Text(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    Text('NFC Status', style: theme.textTheme.titleLarge),
